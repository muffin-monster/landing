...
$(".header .header__bars").on("click",function(){var e=$(".header .header__nav");e.hasClass("shown")?(e.css("right","100%"),e.removeClass("shown")):(e.css("right","0"),e.addClass("shown"))}),$(".header .header__nav span").on("click",function(){var e=$(".header .header__nav");e.hasClass("shown")?(e.css("right","100%"),e.removeClass("shown")):(e.css("right","0"),e.addClass("shown"))}),$(document).on("click",'a[href^="#"]',function(e){e.preventDefault(),"#"!=$(e.target).attr("href")&&$("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top},1e3,"swing")}),$(window).on("scroll",()=>{$(window).scrollTop()>50?$(".header-1").addClass("border-bottom"):$(".header-1").removeClass("border-bottom")}),$(".testimonial__wrapper").on("mouseover click",e=>{if($(e.target).is("img")){let s=$(e.target).parent().parent();s.addClass("active"),s.siblings().hasClass("active")&&s.siblings().removeClass("active")}});var clients=new Swiper(".clients-slider",{loop:!0,autoplay:!0,slidesPerView:1,breakpoints:{991.98:{slidesPerView:3},768:{slidesPerView:2}}}),screenshot=new Swiper(".screenshot-slider",{loop:!0,slidesPerView:4.75,centeredSlides:!0,spaceBetween:30,navigation:{nextEl:".screenshot-nav-next",prevEl:".screenshot-nav-prev"},breakpoints:{0:{slidesPerView:1},991.98:{slidesPerView:2.75},1200:{slidesPerView:3.25},1350:{slidesPerView:3.5},1600:{slidesPerView:3.9},1800:{slidesPerView:4.75}}}),related_post=new Swiper(".blog_related-slider",{loop:!0,slidesPerView:2,navigation:{nextEl:".related-post-nav .screenshot-nav-next",prevEl:".related-post-nav .screenshot-nav-prev"},spaceBetween:30,breakpoints:{0:{slidesPerView:1},991.98:{slidesPerView:2}}});$(".card").on("hide.bs.collapse",function(e){var s=$(e.target).parent().attr("id");$(`#${s} > .card-header > h5`).addClass("hidden")}),$(".card").on("show.bs.collapse",function(e){var s=$(e.target).parent().attr("id");$(`#${s} > .card-header > h5`).removeClass("hidden")}),$(".category__dropdown").on("click",e=>{$(e.target).parents().hasClass("category__dropdown")&&!$(".category__dropdown-box").hasClass("shown")?$(".category__dropdown-box").addClass("shown"):$(e.target).parents().hasClass("category__dropdown-info")&&$(".category__dropdown-box").hasClass("shown")&&$(".category__dropdown-box").removeClass("shown")}),$(".date__dropdown").on("click",e=>{$(e.target).parents().hasClass("date__dropdown")&&!$(".date__dropdown-box").hasClass("shown")?$(".date__dropdown-box").addClass("shown"):$(e.target).parents().hasClass("date__dropdown-info")&&$(".date__dropdown-box").hasClass("shown")&&$(".date__dropdown-box").removeClass("shown")}),$(window).on("click",e=>{$(e.target).parents().hasClass("category__dropdown")||$(".category__dropdown-box").removeClass("shown"),$(e.target).parents().hasClass("date__dropdown")||$(".date__dropdown-box").removeClass("shown")}),$(".nav__dropdown-info").on("click",e=>{let s=$(e.target).closest("li").attr("id");$(`#${s} > .nav__dropdown-box`).toggleClass("shown")});
